...
class GritNpzMotionSource(LocalNpzMotionSource):
    ...
    def append_motion_from_tail(
        ...
        *,
        ...
        prefix = self._build_transition_prefix(
            anchor,
            tgt_first,
        ...
        n_motion = int(aligned["joint_pos"].shape[0])
        ...
        print(
            ...
            f"evaluation_motion_frames={n_motion if is_primary else 0}, easing={transition_easing}"
        )
        return True
